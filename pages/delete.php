...
$PAGE->set_url(new moodle_url('/local/serviceschema/pages/delete.php', ['id' => $id]));
$PAGE->set_title(get_string('action_delete', 'local_serviceschema'));
$PAGE->set_heading(get_string('action_delete', 'local_serviceschema'));
...
$confirmurl = new moodle_url('/local/serviceschema/pages/delete.php', [
    'id' => $id,
    'confirm' => 1,
    'sesskey' => sesskey(),
]);
...
echo $OUTPUT->confirm(
    get_string('confirm_delete', 'local_serviceschema', $schema->name),
    $confirmurl,
    $dashboardurl
);
