...
$string['alert_critical_body'] = 'Critical issue detected with schema "{$a->name}":

{$a->message}';
$string['alert_critical_subject'] = '[CRITICAL] Service schema: {$a}';
...
$string['cachedef_newtoken'] = 'Newly generated web service tokens';
...
$string['copy'] = 'Copy';
$string['copy_token_failed'] = 'Failed to copy token to clipboard';
...
$string['doc_naming_displayname'] = 'Display name';
$string['doc_naming_email'] = 'Email';
$string['doc_naming_role'] = 'Role';
$string['doc_naming_service'] = 'Service';
$string['doc_naming_token'] = 'Token';
$string['doc_naming_username'] = 'Username';
...
$string['messageprovider:healthalert'] = 'Service schema health alerts';
...
$string['pagination_aria_label'] = 'Schema pagination';
...
$string['privacy:metadata:local_servicemanager_history'] = 'Version history of service schema changes, including a reference to the user who made each change.';
$string['privacy:metadata:local_servicemanager_history:change_reason'] = 'The reason recorded for the schema change.';
$string['privacy:metadata:local_servicemanager_history:changedby'] = 'The ID of the user who made the schema change.';
$string['privacy:metadata:local_servicemanager_history:timecreated'] = 'The time when the schema change was made.';
$string['privacy:metadata:local_servicemanager_history:version'] = 'The schema version recorded at the time of the change.';
$string['privacy:metadata:local_servicemanager_schemas'] = 'Web service schemas provisioned by the plugin, including a reference to the service account user created for each schema.';
$string['privacy:metadata:local_servicemanager_schemas:userid'] = 'The ID of the web service account user created for the schema.';
...
$string['schemanotfound_error'] = 'The requested schema was not found.';
...
$string['zipcreationfailed_error'] = 'Failed to create the ZIP archive for export.';
